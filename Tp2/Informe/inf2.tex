...
>>>>>>> ad04867e5437b82ed3fa0ecb9b4018b53ac32587
...
=======
		...
		\State \quad n <- ultimo nodo  de aux
		\State \quad nivel <- n->nivel
		\State \quad tamanioDelUltimoNivel
		\State \quad mientras exista n  y n->nivel = nivel
			\State \quad \quad  retrocedo un nodo
			\State \quad \quad tamanioDelUltimoNivel +=1
		\State \quad finMientras
		\State \quad Para i desde 0 hasta tamaioDelUltimoNivel
		  \State \quad nuevoNodo <-copia de n
			\State \quad \quad nuevoNodo.indice<-n->indice + tamanioDelUltimoNivel
			\State \quad \quad agrego nuevoNodo al final de  aux
		\State \quad FinPara

		\State \quad Para e en ejes
		 \State \quad Si e tiene ambos ejes en el ultimonivel
		 	\State \quad \quad nuevoEje<-copia del eje pero con los nodos del nuevo nivel
		  \State \quad Agrego nuevoEje al final de ejes
		 \State \quad fin Si
		 \State \quad FinPara
		...
		\State \quad para n en nodos
		  \State \quad \quad Si n es pared
				\State\quad \quad \quad  Para e en n.ejes
				\State \quad \quad \quad nuevoEje<-copia del otro nodo q conecta con n con su clon del nuevo nivel
				\State \quad \quad \quad Agrego nuevoEje al final de ejes
				\State \quad \quad \quad Fin Para
			\State \quad \quad FinSi
		\State \quad FinPara

>>>>>>> acbff49e7f52ba9aa0100ff1e79be7c0a4214038
	\end{algorithmic}
\end{algorithm}
...
Indi:-``La X nunca, pero nunca marca el lugar, creeme."
