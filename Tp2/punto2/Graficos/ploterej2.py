...
def main(output, show=False, labels=None):
	...
	Xs.append(list(ns))
	Ys1 = [222392, 222142, 265687, 320300, 366730, 414314, 459383, 505466, 552252, 617429, 666187, 715791, 765568, 814903, 865926]	
	Ys2.append(list(n2))	
	plot = myPlot(Xs, Ys1, Ys2,
		labels=labels,
...
def myPlot(Xs, Ys1, Ys2 , labels, xlabel, ylabel, title, plotter, ylog=False):
